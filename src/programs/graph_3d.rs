...
impl Graph3D {
    pub fn new(gl: &WebGlRenderingContext) -> Self {
        ...
        let positions_and_indices = tools::get_position_grid_n_by_n(super::super::config::GRID_SIZE);
    ...
    pub fn render(
        ...
        let my_3d_matrices = tools::get_3d_matrices(
            bottom,
            top,
            left,
            right,
        ...
        let normals_vals = tools::get_grid_normals(super::super::config::GRID_SIZE, &y_vals);
